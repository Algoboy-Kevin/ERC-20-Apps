  ...
  const DrawerContent = () => {
    return(
      <section className="flex flex-col items-stretch justify-content drawer-content w-full  relative">
        <nav className="left-0 lg:left-80 right-0 bg-base-100 fixed shadow-md p-2 h-content flex items-center z-10">
          <label htmlFor="my-drawer-2" className="btn btn-sm btn-ghost drawer-button lg:invisible">
            <IconMenu className="h-6 w-6"/>
          </label>
          <h1 className="grow text-center mr-16 font-light">
            ERC20 Token Apps
          </h1>
        </nav>
        <div className="max-w-6xl w-full mx-auto px-10 pt-20 h-screen">
          <ERC20App />
        </div> 
